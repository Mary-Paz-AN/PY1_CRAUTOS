...
const FiltroAutosUsados = () => {
    ...
    const carrocerias = ['Sedán', 'SUV', 'Hatchback', 'Camioneta', 'Convertible', 'Coupe', 'Pick-up'];
    const provincias = ['San José', 'Alajuela', 'Cartago', 'Heredia', 'Guanacaste', 'Puntarenas', 'Limón'];
    const añosDesde = [2020, 2021, 2022, 2023, 2024];
    const añosHasta = [2020, 2021, 2022, 2023, 2024];
    const estados = ['Ambos', 'Usado', 'Nuevo']
    ...
    return (
        <div className="filterContainer">
            ...
            <form>
                ...
                <label className='labelStyle'>
                    Estado:
                    <select className='selectStyle' value={estado} onChange={handleChange(setEstado)}>
...
export default FiltroAutosUsados;
